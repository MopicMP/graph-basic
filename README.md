...
> Basic graph data structure and traversal

[![PyPI version](https://badge.fury.io/py/graph-basic.svg)](https://pypi.org/project/graph-basic/)
...
```bash
pip install graph-basic
```

## Quick Start

```python
from graph_basic import basic
